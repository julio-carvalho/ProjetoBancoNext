...
public class Menu {
	...
	public void menuLogado() {
		...
		System.out.println("| 13 - Desbloquear Cartão de Débito                                    |");
		System.out.println("+----------------------------------------------------------------------+");
		System.out.println("| *    CARTÃO DE CRÉDITO                                               |");
		System.out.println("| 14 - Ativar Cartão de Crédito                                        |");
		System.out.println("| 15 - Desativar Cartão de Crédito                                     |");
		System.out.println("| 16 - Realizar compra com o Cartão de Crédito                         |");
		System.out.println("| 17 - Desbloquear Cartão de Crédito                                   |");
		System.out.println("| 18 - Exibir Fatura                                                   |");
		System.out.println("| 19 - Pagar Fatura                                                    |");
		System.out.println("| 20 - Obter apólice de seguro                                         |");
		System.out.println("| 21 - Exibir regras do seguro                                         |");
		System.out.println("| 22 - Remover apólice de seguro                                       |");
		System.out.println("+----------------------------------------------------------------------+");
